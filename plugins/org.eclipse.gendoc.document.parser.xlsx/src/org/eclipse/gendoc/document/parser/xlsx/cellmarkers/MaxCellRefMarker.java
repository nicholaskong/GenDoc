...
public class MaxCellRefMarker extends CellRefMarker implements ICellRefMarker {
	public MaxCellRefMarker(String mark, String xpath, String attrPath) {
		super(mark, xpath, attrPath);
	}

	public MaxCellRefMarker(String mark, String relationType, String xpath, String attrPath) {
