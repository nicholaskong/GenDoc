...
public class ODSFactory implements DocumentFactory
{
    ...
    /* (non-Javadoc)
     * @see org.eclipse.gendoc.document.parser.documents.DocumentFactory#loadDocument(java.io.File)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.gendoc.document.parser.documents.DocumentFactory#loadDocument(java.io.File, java.util.Map)
     */
