...
/**
 * The process extension service maintains the list of processes to be run by Gendoc.
 * 
 * @author Kris Robertson
 * 
 * @see org.eclipse.gendoc.process.IProcessExtensionService
 */
public class ProcessExtensionService extends AbstractService implements IProcessExtensionService
{
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.process.IProcessExtensionService#getNumProcesses()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.process.IProcessExtensionService#getProcesses()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.process.IProcessExtensionService#next()
     */
    public boolean next()
    {
