...
/**
 * GendocServices creates and maintains the services used during the Gendoc generation process. Clients can request a
    ...
    private void initialize()
    {
        ...
        for (ServiceTypeExtension serviceTypeExtension : ServiceTypesExtensionPoint.getDefault().getServiceTypeExtensions())
        {
            ...
            catch (ServiceException e)
            {
                ...
                // in some case logger is not initialized for debug stack strace is printed
                e.printStackTrace();
            }
        }
