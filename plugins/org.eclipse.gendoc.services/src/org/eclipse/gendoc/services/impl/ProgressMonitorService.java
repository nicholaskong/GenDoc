 ...
 * 
 * @see org.eclipse.gendoc.services.IProgressMonitorService
 */
public class ProgressMonitorService extends AbstractService implements IProgressMonitorService
{
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#beginTask(String, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#getDelegatingMonitor()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#getMonitor()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#isCanceled()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#setMonitor(org.eclipse.core.runtime.IProgressMonitor)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#subMonitor(int, String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.services.IProgressMonitorService#worked()
     */
