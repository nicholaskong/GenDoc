...
public class StructuredTag extends AbstractTag
{
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.ITag#getAttributes()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.ITag#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.ITag#getValue()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.ITag#isComplete()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.ITag#isStructured()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.ITag#setValue(String)
     */
    @Override
        ...
        while ((iCurrent < iTagEnd) && (iCurrent < text.length()))
        {
            ...
            if (iNameEnd == -1)
            {
               if( attributes.get("id") != null){
            	   throw new IncompleteTagException(this.name, attributes.get("id"), "attribute '"+ attributeName+ "' is not correctly filled.");
               }
               else{
