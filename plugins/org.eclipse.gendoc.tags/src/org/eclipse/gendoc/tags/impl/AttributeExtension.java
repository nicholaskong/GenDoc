...
/**
 * The org.eclipse.gendoc.tags.IAttributeExtension class describes an attribute of a TagExtension.
 * 
 * @see org.eclipse.gendoc.tags.IAttributeExtension
...
public class AttributeExtension extends AbstractExtension implements IAttributeExtension
{
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.IAttributeExtension#getDefaultValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.IAttributeExtension#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.IAttributeExtension#getType()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.gendoc.tags.IAttributeExtension#isRequired()
     */
